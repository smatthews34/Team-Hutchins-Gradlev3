                ...
                */
                ...
                if (courses.isEmpty()) {
                    ...
                    if (addOption.equals("yes") || addOption.equals("Yes")) {
                        //TODO
                        Scanner add0 = new Scanner(System.in);
                        String addOption0 = "";
                        while(!addOption0.equals("done")) {
                            System.out.println("Enter course in the format: \"CODE ### A\" or for a lab \"CODE ### A L\", to be added or enter 'done' if finished adding: ");
                            System.out.print(">");
                            addOption0 = add0.nextLine();
                            if (!addOption0.equals("done")) {
                                if(addOption0.charAt(addOption0.length()-1) == 'L' && addOption0.length() == 12){
                                    char c = addOption0.charAt(addOption0.length()-3);
                                    addOption0 = addOption0.substring(0,addOption0.length()-3);
                                    addOption0 = addOption0 + " " + c + "    L";
                                }else{
                                    char c = addOption0.charAt(addOption0.length()-1);
                                    addOption0 = addOption0.substring(0,addOption0.length()-1);
                                    addOption0 = addOption0 + " " + c;
                                }
                                Course a = cl.getCourse(addOption0);
                                ...
                                if (a != null) {
                                    ...
                                    System.out.println("Please enter a valid class.");
                                    lg.logger.warning(user.username + " added the invalid course: " + addOption0);
                                }
                            }
                        }
                    }
